...
<div class="jumbotron" style="background-color: white";>
            <h1 style="padding: 20px; border-width: 5px; border-style: solid;">Undergraduate Students</h1>
        </div> <br><br>
<?php
  
  // include 'css/team_css.css';

  include "SimpleXLSX.php";  

  if ( $xlsx = SimpleXLSX::parse('undergraduates.xlsx') ) {
    // echo '<table><tbody>';
    $i = 0;
